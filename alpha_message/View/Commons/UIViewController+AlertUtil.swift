...
extension UIViewController{
    ...
    func displayAlertWithTextField(title:String? = nil, message:String? = nil,
                      style:UIAlertController.Style = UIAlertController.Style.alert,
                      btns:[BtnType], completion: ( (_ withType:(Int,String?) ) -> ())?) {
        ...
        for (index, btn) in btns.enumerated() {
            ...
            // ③ UIAlertControllerにActionを追加
            let action: UIAlertAction = UIAlertAction(title: btn.title, style: style!, handler:{ (action: UIAlertAction!) -> Void in
